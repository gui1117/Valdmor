...
var Physics2DDebugDraw = (function () {
    ...
    Physics2DDebugDraw.prototype._drawShape = function (shape) {
        ...
        /* tslint:disable:no-bitwise */
        var color = this._colors[shape.body._type | (body.sleeping ? 4 : 0) | (shape.sensor ? 8 : 0) | (body._bullet ? 16 : 0)] || [0,1,0,1];
    ...
    Physics2DDebugDraw.create = function (params) {
        ...
        // Generated from assets/shaders/debugphys2d.cgfx
        var shader = gd.createShader(debugphys2d_cgfx);
